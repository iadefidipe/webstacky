...
const data = [
  {
    ...
    title: `Scale your idea in the successful blockchain models`,
    description: `At Webstacky, we scale from your idea to a full-blown at a very fast pace`,
  ...
  },
  {
    ...
    description: `
    You value solid professionals and quality work Quality, dedicated talent is one of your most important priorities. `,
    moreLink: '#explore-more',
    image: tabImage1,
    list: [
      'Defi',
  ...
  },
  {
    ...
    description: `We build bridges, not walls— our engineers work as part of your cross-border organization while we take care of all supporting services.`,
    moreLink: '#explore-more',
    image: tabImage1,
    list: [
      'Defi',
